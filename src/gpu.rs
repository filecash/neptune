...
lazy_static! {
    pub static ref FUTHARK_CONTEXT: Mutex<FutharkContext> = Mutex::new(match FutharkContext::new(){
        Ok(v) => v,
        _ => panic!("new FutharkContext failed!"),
    });
}
